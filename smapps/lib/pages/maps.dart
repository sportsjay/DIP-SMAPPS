...
// Place is represented by object 'Places' contain 'name','desc', 'Lat','Lon','Image'
  List<Placee> initplace = [
    new Placee("The Hive", 1.343235, 103.682792, "assets/assets1.jpg",
        "The Hive", "The Hive"),
    new Placee("Lee Kong Chian Lecture Theatre", 1.342636, 103.682327,
        "assets/assets2.jpg", "Location 2", "LKC LT LV2"),
    new Placee("The Photonics Institute", 1.342980, 103.680120,
        "assets/assets3.jpg", "Location 3", "Photonics Lv1"),
    new Placee("Rolls-Royce", 1.342261, 103.680608, "assets/assets4.jpg",
        "Location 4", "Rolls-Royce LVB1"),
    new Placee("LTA-1", 1.347313, 103.680379, "assets/assets5.jpg",
        "Location 5", " LTA-Lecture Hall"),
    new Placee("Ntu Fine Food", 1.342437, 103.682472, "assets/assets6.jpg",
        "Location 6", "Nearest canteen to EEE"),
    new Placee("Triple-E Office", 1.343252, 103.680980, "assets/assets7.jpg",
        "Location 7", "Admins office "),
    new Placee("Satellite Center", 1.343135, 103.680977, "assets/assets8.jpg",
        "Location 8", "LV B3"),
    new Placee("TR 61-69", 1.343403, 103.681238, "assets/assets9.jpg",
        "Location 9", "You can Find Tr 61-69 Here"),
    new Placee("LT 23", 1.342949, 103.681699, "assets/assets10.jpg",
        "Location 10", "Lecture Hall 23"),
  ];
...
//List of initial place scoped
  final List<Placee> pr = [
    ...
    new Placee("LTA-1", 1.347313, 103.680379, "assets/assets5.jpg",
        "Location 5", "LTA-Lecture Hall"),
    new Placee("Ntu Fine Food", 1.342437, 103.682472, "assets/assets6.jpg",
        "Location 6", "Nearest canteen for Triple E"),
    new Placee("Triple-E Office", 1.343252, 103.680980, "assets/assets7.png",
        "Location 7", "Admins office "),
    new Placee("Satellite Center", 1.343135, 103.680977, "assets/assets8.jpg",
        "Location 8", "Sate center"),
    new Placee("TR 61-69", 1.343403, 103.681238, "assets/assets9.jpg",
        "Location 9", "You can Find Tr 61-69 Here"),
    new Placee("LT 23", 1.342949, 103.681699, "assets/assets10.jpg",
        "Location 10", "Lecture Hall 23"),
...
//List of initial place if search input = ""
  ...
  final List<Placee> recentPlaces = [
    ...
    new Placee("Lee Kong Chian Lecture Theatre", 1.342636, 103.682327,
        "assets/assets2.jpg", "Location 2", "LKC LT Lv 2"),
    new Placee("The Photonics Institute", 1.342980, 103.680120,
        "assets/assets3.jpg", "Location 3", "Photonics Lv1"),
    new Placee("Rolls-Royce", 1.342261, 103.680608, "assets/assets4.jpg",
        "Location 1", "Rolls-Royce LvB1"),
    new Placee("LtA-1", 1.347313, 103.680379, "assets/assets5.jpg",
        "Location 1", "LTA-Lecture Hall"),
    new Placee("Ntu Fine Food", 1.342437, 103.682472, "assets/assets6.jpg",
        "Location 1", "Nearest canteen for Triple E"),
    new Placee("Triple-E Office", 1.343252, 103.680980, "assets/assets7.jpg",
        "Location 1", "Admins office"),
    new Placee("Satellite Center", 1.343135, 103.680977, "assets/assets8.jpg",
        "Location 1", "Sate center"),
    new Placee("TR 61-69", 1.343403, 103.681238, "assets/assets9.jpg",
        "Location 1", "You can Find Tr 61-69 Here"),
    new Placee("LT 23", 1.342949, 103.681699, "assets/assets10.jpg",
        "Location 1", "Lecture Hall 23"),
  ];
  ...
  Widget buildResults(BuildContext context) {
    ...
    return Scaffold(body: Center(child: Text('No location found!')));
  }
}
